...
abstract class $PhotoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({XFile? file, bool isLoading});
}
...
class _$PhotoModelImpl implements _PhotoModel {
  const _$PhotoModelImpl({this.file, this.isLoading = false});
  ...
  @override
  String toString() {
    return 'PhotoModel(file: $file, isLoading: $isLoading)';
  }
...
abstract class _PhotoModel implements PhotoModel {
  const factory _PhotoModel({final XFile? file, final bool isLoading}) =
      _$PhotoModelImpl;
